...
?>
    ...
    <header class="">
        ...
        <nav class="navbar navbar-light bg-transparent col-12">
            ...
            <a> <p>
                    <a class="mt-2 ml-3 btn btn-fondo btn-outline-dark btn-lg" data-toggle="collapse" href="#collapseExample" role="button"
                ...
                <div class="collapse" id="collapseExample">
                    ...
                    <?php foreach($productos as $producto):?>
                        <ul class="list-group">
                            <li class="list-group-item list-group-item-primary"><?php echo($producto["nombreProducto"])?></li>
                        </ul>
                    <?php endforeach?>
                    </div>
                </div>
